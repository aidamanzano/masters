...
def random_mpz_lt(maximum, strong_random=random): #max here is given as q
    n_bits = int(math.floor(math.log(maximum, 2))) #math.floor rounds down to nearest integer. #math.log(x, base) Returns the logarithm
