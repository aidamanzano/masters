...
class EncryptedAnswer(HeliosObject):
    ...
    @classmethod
    def fromElectionAndAnswer(cls, question, answer_indexes, pk):
        """
        ...
        for answer_num in range(len(answers)):
            ...
            if answer_num in answer_indexes: #list of indexes for the candidates you want to vote for. if you have an index that in the list of your choices, then set it to 1
                plaintext_index = 1
